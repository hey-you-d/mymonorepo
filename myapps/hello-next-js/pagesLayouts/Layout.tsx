...
import { TASKS_CRUD, MONOREPO_PREFIX } from '@/lib/app/common';
        ...
        <section className={styles.page}>
            ...
            <main className={styles.main}>
                ...
                <ul>
                    ...
                    <li><Link href={`${MONOREPO_PREFIX}/api/tasks/v1/sql`}>Tasks API Endpoints</Link></li>
                    <li><Link href={`${MONOREPO_PREFIX}/api/tasks/v1/bff`}>Tasks BFF Endpoints (used by the client-side variant Model component)</Link></li>
                </ul>
                <hr/>
                {children}
            </main>
